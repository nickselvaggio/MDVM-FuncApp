...
- Optional hierarchical data reorganization (OS Platform → Device Name → Device Metadata + Vulnerabilities)
- Automatic machine tags retrieval from Microsoft Defender API
- Device metadata includes: tags, RBAC group, OS details, and architecture
...
2. **Configure API Permissions**: Add the following permissions:
   - **WindowsDefenderATP** - **Vulnerability.Read.All** (Application permission) - Required for fetching vulnerability data
   - **WindowsDefenderATP** - **Machine.Read.All** (Application permission) - Required for fetching device details and machine tags
